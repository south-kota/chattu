...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.t3Home, () => path.join(homeDirectory, ".apna-chat"));
  ...
  const userDataDirName = isDevelopment ? "apna-chat-dev" : "apna-chat";
  const legacyUserDataDirName = isDevelopment ? "Apna Chat (Dev)" : "Apna Chat (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.southkota.apnachat.dev" : "com.southkota.apnachat",
    linuxDesktopEntryName: isDevelopment ? "apna-chat-dev.desktop" : "apna-chat.desktop",
    linuxWmClass: isDevelopment ? "apna-chat-dev" : "apna-chat",
    userDataDirName,
